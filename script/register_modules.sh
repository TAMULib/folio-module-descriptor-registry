#!/bin/bash
#
# Register modules using the module descriptors.
#
...
# TODO: https://open-libr-foundation.slack.com/archives/C9BBWRCNB/p1581520795396900?thread_ts=1581518594.392700&cid=C9BBWRCNB
# get descriptor from registry: http://folio-registry.aws.indexdata.com/_/proxy/modules/mod-source-record-manager-2.1.0-SNAPSHOT.217
